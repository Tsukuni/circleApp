...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { adver_image: @advertisement.adver_image, url: @advertisement.url } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { adver_image: @advertisement.adver_image, url: @advertisement.url } }

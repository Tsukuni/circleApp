...
class CapacitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create capacity" do
    assert_difference('Capacity.count') do
      post capacities_url, params: { capacity: { context: @capacity.context, image: @capacity.image } }
    end
  ...
  test "should update capacity" do
    patch capacity_url(@capacity), params: { capacity: { context: @capacity.context, image: @capacity.image } }
